...
The difference of salary shown in Figure(x) is due to factors other than gender. For example, men on average have higher seniority levels and hence are compensated with higher salary based on this higher added-value to the company. Candidates hired have a much higher gpa than those who did not get hired, as shown in Figure(x). 
